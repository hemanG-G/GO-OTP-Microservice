...
func (app *Config) twilioSendOTP(phoneNumber string) (string, error) { // App router as Reciever
	params := &twilioApi.CreateVerificationParams{}
	params.SetTo(phoneNumber)
	params.SetChannel("sms")

	// making request to twilio service  and getting response
...
func (app *Config) twilioVerifyOTP(phoneNumber string, code string) error {
	...
	// making request to twilio service to verify
